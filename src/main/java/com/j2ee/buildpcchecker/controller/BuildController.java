...
public class BuildController {
        ...
        @ApiResponses(value = {
                        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Compatibility check completed successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class), examples = {
                                        @ExampleObject(name = "Compatible Build", value = """
                                                        {
                                                          "code": 1000,
                                                          "message": "Success",
                                                          "result": {
                                                        ...
                                                        """),
                                        @ExampleObject(name = "Incompatible Build", value = """
                                                        {
                                                          "code": 1000,
                                                          "message": "Success",
                                                          "result": {
        ...
        public ApiResponse<CompatibilityResult> checkCompatibility(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "Build configuration with component IDs (all fields optional)", required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = BuildCheckRequest.class), examples = @ExampleObject(name = "Sample Request", value = """
                                        {
                                          "cpuId": "uuid-cpu-id",
         ...
         * POST /builds
         */
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Build saved successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class), examples = @ExampleObject(name = "Success Response", value = """
                        {
                          "code": 1000,
        ...
        public ApiResponse<PcBuildResponse> saveBuild(
                        @io.swagger.v3.oas.annotations.parameters.RequestBody(description = "PC Build configuration with name, description, and parts map", required = true, content = @Content(mediaType = "application/json", schema = @Schema(implementation = SaveBuildRequest.class), examples = @ExampleObject(name = "Sample Build Request", value = """
                                        {
                                          "name": "Gaming Build 2026",
                                          "description": "Intel i9 + RTX 4090 Gaming Setup",
                                          "parts": {
         ...
         * GET /builds
         */
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Builds retrieved successfully")
        @GetMapping
         ...
         * GET /builds/{id}
         */
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Build retrieved successfully")
        @GetMapping("/{id}")
         ...
         * DELETE /builds/{id}
         */
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Build deleted successfully")
        @DeleteMapping("/{id}")
         ...
         * POST /builds/analyze
         */
        @io.swagger.v3.oas.annotations.responses.ApiResponse(responseCode = "200", description = "Build analysis completed successfully", content = @Content(mediaType = "application/json", schema = @Schema(implementation = ApiResponse.class), examples = @ExampleObject(name = "Analysis Result", value = """
                        {
                          "code": 1000,
                          "message": "Success",
                          "result": {
